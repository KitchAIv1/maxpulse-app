...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_plan_progress_user_id 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sleep_sessions_user_id 
  ON sleep_sessions(user_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_mood_checkins_user_id 
  ON mood_checkins(user_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_pedometer_snapshots_user_id 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sleep_sessions_user_date 
  ON sleep_sessions(user_id, DATE(start_ts));

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_mood_checkins_user_date 
  ON mood_checkins(user_id, DATE(timestamp));

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_pedometer_snapshots_user_ts 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_app_user_profiles_activation_code 
